...
sidebar:
  order: 7
slug: 0.11.0/guides/remote-commands
---
...
* [Keybind Configuration](/0.11.0/configuration/keybinds) - Configure what keys do what
* [Tab Configuration](/0.11.0/configuration/tabs) - Set up custom tab names
* [CLI Reference](/0.11.0/reference/cli-command-mode) - Full command reference
