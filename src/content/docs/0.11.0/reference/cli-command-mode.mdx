...
sidebar:
  order: 3
slug: 0.11.0/reference/cli-command-mode
---
...
Additionally, these commands can also be bound to a key using the `Command` action as [described here](/0.11.0/configuration/keybinds#global)
...
For detailed information and more examples, see the [Remote Commands Guide](/0.11.0/guides/remote-commands).
