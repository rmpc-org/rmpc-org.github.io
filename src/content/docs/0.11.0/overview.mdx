...
import queueImg from "../../../assets/0.11.0/queue.png";
import searchImg from "../../../assets/0.11.0/search.png";
import browserImg from "../../../assets/0.11.0/browser.png";
...
check out the [CLI reference](/0.11.0/reference/cli-command-mode).
...
Learn more about remote control in the [Remote Commands Guide](/0.11.0/guides/remote-commands).
