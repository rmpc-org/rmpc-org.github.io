...
sidebar:
  order: 35
slug: 0.11.0/configuration/stickers
---
...
You must have [sticker\_file](https://mpd.readthedocs.io/en/latest/mpd.conf.5.html#optional-parameters)
...
| playCount | How many times a song was played. Requires [configuration](/0.11.0/guides/on_song_change/#track-song-play-count).                                                                                                   |
