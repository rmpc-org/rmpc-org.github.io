...
sidebar:
    order: 30
slug: 0.11.0/configuration/keybinds
---
...
<ConfigValue
    name="global"
    type="other"
    customText="{ &#x22;p&#x22;: Play, &#x22;s&#x22;: Stop, &#x22;X&#x22;: Stop, ...}"
/>
...
|                                      `r`                                      | [Rate()](#rate)                             | Set song rating, must have [stickers](/0.11.0/configuration/stickers) configured                                                   |
...
Must have stickers configured, please check [stickers](/0.11.0/configuration/stickers)
