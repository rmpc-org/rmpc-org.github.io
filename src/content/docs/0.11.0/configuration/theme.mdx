...
sidebar:
    order: 11
slug: 0.11.0/configuration/theme
---
...
<LinkCard title="layout" description="Configuration of rmpc's base layout" href="/0.11.0/configuration/layout/" />
...
out [components](/0.11.0/configuration/layout#components) section in the layout page for more information.
...
Configures how the Cava music visualizer is displayed. More info on the [cava](/0.11.0/configuration/cava) page.
...
Do not use. Deprecated in favor of the [layout config](/0.11.0/configuration/layout).
...
<ConfigValue
    ...
    href="/0.11.0/configuration/song-table/"
/>
...
<ConfigValue
    ...
    type="other"
    customText="<property[]>"
    href="/0.11.0/configuration/properties"
/>

Format used to display song in the various browser panes (directories, albums, artists, ...).
Is the same format as [song_table_format](/0.11.0/configuration/song-table#prop) except the styles are ignored.
