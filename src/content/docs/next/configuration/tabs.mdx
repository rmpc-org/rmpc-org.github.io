...
<ConfigValue
    name="panes"
    customText="(size: '50%', borders: <borders>, border_title: <string>, border_title_style: <Style>, border_title_position: Top | Bottom, border_title_alignment: Left | Center | Right, pane: Pane | Split | Component"
/>
...
<ConfigValue name="border_title" type="string" />
<ConfigValue name="border_title_style" customText="<style>" />
...
(
    ...
    pane: Split(direction: Vertical, panes: [
        ...
        (
            ...
            border_title_style: (fg: "rgb(126, 144, 172)"),
