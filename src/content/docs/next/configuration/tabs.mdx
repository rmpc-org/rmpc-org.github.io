...
<ConfigValue
    name="panes"
    customText="(size: '50%', borders: <borders>, border_title: <property>[], border_title_position: Top | Bottom, border_title_alignment: Left | Center | Right, pane: Pane | Split | Component"
/>
