...
Whether rmpc should watch the <a href={path("configuration/#lyrics_dir")}>lyrics_dir</a> for changes and automatically load new files or update lyrics from changed files. Disabled by default.
...
Defines how the songs are sorted in the browser panes. This is a list of <a href={path("configuration/properties/#song-properties")}>song properties</a>.
