...
A function that is called after the connection to MPD is successfully re-established, if it was
previously disconnected. It takes self as its only argument.
