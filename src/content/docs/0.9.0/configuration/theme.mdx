...
sidebar:
    order: 40
slug: 0.9.0/configuration/theme
---
...
<LinkCard title="layout" description="Configuration of rmpc's base layout" href="/0.9.0/configuration/layout/" />
...
out [components](/0.9.0/configuration/layout#components) section in the layout page for more information.
...
Configures how the Cava music visualizer is displayed. More info on the [cava](/0.9.0/configuration/cava) page.
...
Do not use. Deprecated in favor of the [layout config](/0.9.0/configuration/layout).
...
<ConfigValue
    ...
    href="/0.9.0/configuration/song-table/"
/>
...
<ConfigValue
    ...
    type="other"
    customText="<song_table_format>"
    href="/0.9.0/configuration/song-table#property"
/>

Format used to display song in the various browser panes (albums, artists, ...). Is the same format
as [song_table_format](/0.9.0/configuration/theme#song_table_format) except the styles are ignored.

Defaults to `Track Artist - Title`

### header

<ConfigValue name="header" type="other" customText="<header[]>" href="/0.9.0/configuration/header/" />
...
<LinkCard title="header" description="Configuration of the window header" href="/0.9.0/configuration/header/" />
