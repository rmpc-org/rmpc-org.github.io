...
sidebar:
    order: 60
slug: 0.9.0/configuration/header
---
...
<ConfigValue name="kind" type="other" customText="<header_property_kind>" href="#header_property_kind" />
...
<ConfigValue name="kind" type="other" customText="Group(<property>[])" href="#property" />
...
Can display values from the currently playing song metadata, just like in the [song
table](/0.9.0/configuration/song-table/#property), info about the player status (volume, playing or stopped, current bitrate,
...) or a predefined widget.

### Sticker

<ConfigValue name="kind" type="other" customText="Sticker(&#x22;<sticker_key&#x22;)" />

Can display stickers from the currently playing song, just like in the [song table](/0.9.0/configuration/song-table/#sticker).
