...
sidebar:
    order: 50
slug: 0.9.0/configuration/song-table
---
...
<ConfigValue name="prop" type="other" customText="<property>" href="#property" />
...
<ConfigValue name="kind" type="other" customText="<property_kind>" href="#property_kind" />
...
set in its `mpd.conf`. You can use this to for example display play count of the song with the following [on_song_change](/0.9.0/guides/on_song_change/#track-song-play-count).
