...
sidebar:
  order: 25
slug: 0.9.0/configuration/cava
---

import { Steps } from "@astrojs/starlight/components";
import { Image } from "astro:assets";
import example_cava from "../../../../assets/0.9.0/cava_preview.png";
...
The look of visualiser can be configured in your [theme](/0.9.0/configuration/theme#cava)
