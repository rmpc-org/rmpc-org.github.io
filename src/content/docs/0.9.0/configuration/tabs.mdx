...
sidebar:
    order: 12
slug: 0.9.0/configuration/tabs
---

import ConfigValue from "../../../../components/ConfigValue.tsx";
import { Image } from "astro:assets";
import example_property_pane from "../../../../assets/0.9.0/example_property_pane.png";
...
Check out the [default config](/0.9.0/reference/config/) for reference.
...
- `Component("<component_name>")` - Displays a [component](/0.9.0/configuration/layout#components)
...
- `Cava` - Displays a music visualiser using Cava. More info on its own [page](/0.9.0/configuration/cava).
...
- `Property` - A special pane which can display any property as described in the [Header config](/0.9.0/configuration/header/#header_property)
...
<ConfigValue
    ...
    href="/0.9.0/configuration/header/#header_property_kind"
/>
