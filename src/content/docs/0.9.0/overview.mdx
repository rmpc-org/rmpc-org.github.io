...
import queueImg from "../../../assets/0.9.0/queue.png";
import searchImg from "../../../assets/0.9.0/search.png";
import browserImg from "../../../assets/0.9.0/browser.png";
...
check out the [CLI reference](/0.9.0/reference/cli-command-mode)
