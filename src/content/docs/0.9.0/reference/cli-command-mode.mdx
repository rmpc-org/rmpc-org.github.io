...
sidebar:
  order: 3
slug: 0.9.0/reference/cli-command-mode
---
...
Additionally, these commands can also be bound to a key using the `Command` action as [described here](/0.9.0/configuration/keybinds#global)
