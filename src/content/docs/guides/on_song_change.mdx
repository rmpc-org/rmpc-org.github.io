...
Rmpc provides [on_song_change](/configuration#on_song_change) property in the config file
...
3.  In your rmpc's `config.ron` specify [on_song_change](/configuration#on_song_change) property
