...
- Clicking the table header sorts by the given column

### Volume Pane

- Supports changing volume by dragging and clicking on the bar
- Scrolling also raises/decreases the volume
...
- Middle click item in the middle column to add the whole directory(or single song) to queue
