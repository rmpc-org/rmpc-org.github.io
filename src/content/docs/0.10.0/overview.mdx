...
import queueImg from "../../../assets/0.10.0/queue.png";
import searchImg from "../../../assets/0.10.0/search.png";
import browserImg from "../../../assets/0.10.0/browser.png";
...
check out the [CLI reference](/0.10.0/reference/cli-command-mode).
...
Learn more about remote control in the [Remote Commands Guide](/0.10.0/guides/remote-commands).
