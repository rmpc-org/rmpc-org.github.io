...
sidebar:
  order: 5
slug: 0.10.0/guides/on_song_change
---

import { Steps } from "@astrojs/starlight/components";

Rmpc provides [on\_song\_change](/0.10.0/configuration#on_song_change) property in the config file
...
<Steps>
  ...
  3. In your rmpc's `config.ron` specify [on\_song\_change](/0.10.0/configuration#on_song_change) property
