...
sidebar:
  order: 35
slug: 0.10.0/configuration/stickers
---
...
| playCount | How many times a song was played. Requires [configuration](/0.10.0/guides/on_song_change/#track-song-play-count).                                                                                                   |
