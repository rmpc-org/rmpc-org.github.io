...
sidebar:
    order: 12
slug: 0.10.0/configuration/layout
---

import { LinkCard, CardGrid } from "@astrojs/starlight/components";
import ConfigValue from "../../../../components/ConfigValue.tsx";
import { Image } from "astro:assets";
import example_layout_album_art_in_header from "../../../../assets/0.10.0/example_layout_album_art_in_header.png";
import example_layout_default from "../../../../assets/0.10.0/example_layout_default.png";
import example_layout_default_borders from "../../../../assets/0.10.0/example_layout_default_borders.png";

Layout controls the base layout of the application. This layout is similar to [tabs](/0.10.0/configuration/tabs#pane)
configuration except it contains a single `Pane` or `Split`. It is configured inside your [theme.ron](/0.10.0/configuration/theme#layout).

<ConfigValue name="layout" type={["Pane", "Split", "Component"]} href="/0.10.0/configuration/tabs/#pane" />
...
currently active tab configured in [tabs](/0.10.0/configuration/tabs). The pane sizes can be either a percent
