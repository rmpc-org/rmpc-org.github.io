...
sidebar:
  order: 14
slug: 0.10.0/configuration/panes
---

import { LinkCard, CardGrid } from "@astrojs/starlight/components";
import ConfigValue from "../../../../components/ConfigValue.tsx";
import { Image } from "astro:assets";
import example_property_pane from "../../../../assets/0.10.0/example_property_pane.png";
...
| `Cava`                               | Displays a music visualiser using Cava. More info on its own [page](/0.10.0/configuration/cava).                                                                                                                                                                                   |
...
| `Property`                           | A special pane which can display a list of [properties](/0.10.0/configuration/properties) including styling, default values etc. Check the [Example](#property) for more info.                                                                                                     |
...
The property pane, can be used to display one or more [properties](/0.10.0/configuration/properties).
...
<ConfigValue name="header" type="other" customText="<row[]>" href="#row" />
...
the [properties](/0.10.0/configuration/properties) page.
