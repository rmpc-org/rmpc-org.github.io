...
Directory where rmpc should search for `lrc` files. Please see the [lyrics page](/0.10.0/configuration/lyrics) for more information.
...
<LinkCard
    ...
    href="/0.10.0/configuration/theme/"
/>

### album_art

<ConfigValue name="album_art" type="other" href="/0.10.0/configuration/album-art" />

Various options for album art display. By default should not be needed to be specified. More info at [album art page](/0.10.0/configuration/album-art#configuration)

### cava

<ConfigValue name="cava" type="other" customText="<Cava>" href="/0.10.0/configuration/cava" />
...
More info on the [cava](/0.10.0/configuration/cava) page.

### keybinds

<ConfigValue name="keybinds" type="other" customText="<keybinds>" href="/0.10.0/configuration/keybinds/" />

Keybinds to use. The default keybinds are used if this property is absent. More info at:

<LinkCard title="Configuring keybinds" description="Customize the keybinds" href="/0.10.0/configuration/keybinds/" />
...
send [notifications](/0.10.0/guides/on_song_change) when the song changes.
...
arguments passed to the command. Nothing will be executed if left empty. Check [on_resize](/0.10.0/guides/on_resize)
for more info.

### search

<ConfigValue name="search" type="other" customText="<search>" href="/0.10.0/configuration/search/" />

Configures what tags are searchable on the Search pane. Also sets whether the search should be case insensitive by
default and what kind of search mode to perform. More detail in the [Search](/0.10.0/configuration/search) section.
If not specified, the [default values](/0.10.0/reference/config) are used.
...
Defines how the songs are sorted in the browser panes. This is a list of [song properties](/0.10.0/configuration/properties/#song-properties).
...
- `SortFormat` - Similar to `Format` but songs are sorted by [browser_song_sort](/0.10.0/configuration/#browser_song_sort).
