...
sidebar:
  order: 25
slug: 0.10.0/configuration/cava
---

import { Steps } from "@astrojs/starlight/components";
import { Image } from "astro:assets";
import example_cava from "../../../../assets/0.10.0/cava_preview.png";
...
<Steps>
  ...
  3. Configure the pane layout to include Cava. This goes in your `config.ron` under the tabs section. Below is
     ...
     See [Panes documentation](/0.10.0/configuration/panes) for more information about configuring panes.
</Steps>

## Theming

The look of visualiser can be configured in your [theme](/0.10.0/configuration/theme#cava)
