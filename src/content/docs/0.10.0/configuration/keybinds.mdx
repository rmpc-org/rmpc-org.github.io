...
sidebar:
  order: 30
slug: 0.10.0/configuration/keybinds
---
...
<ConfigValue name="keybinds" type="other" customText="(global: <kebyinds_map>, navigation: <keybinds_map>, queue: <keybinds_map>)" />
...
|                 | [Rate()](#rate)             | Set song rating, must have [stickers](/0.10.0/configuration/stickers) configured                                                          |
...
Must have stickers configured, please check [stickers](/0.10.0/configuration/stickers)
