...
Additionally, these commands can also be bound to a key using the `Command` action as [described here](/configuration/keybinds#global)
...
For detailed information and more examples, see the [Remote Commands Guide](/guides/remote-commands).
