...
Layout controls the base layout of the application. This layout is similar to [tabs](/configuration/tabs#pane)
configuration except it contains a single `Pane` or `Split`. It is configured inside your [theme.ron](/configuration/theme#layout).

<ConfigValue name="layout" type={["Pane", "Split", "Component"]} href="/configuration/tabs/#pane" />
...
currently active tab configured in [tabs](/configuration/tabs). The pane sizes can be either a percent
