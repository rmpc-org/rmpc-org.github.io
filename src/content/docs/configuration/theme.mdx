...
<LinkCard title="layout" description="Configuration of rmpc's base layout" href="/configuration/layout/" />
...
out [components](/configuration/layout#components) section in the layout page for more information.
...
Configures how the Cava music visualizer is displayed. More info on the [cava](/configuration/cava) page.
...
<ConfigValue name="border_symbol_sets" customText="Map<string, <border_set>>" />

Allows you to define reusable border symbol sets which can be used with the `Library("<name>")` variant
in your pane's `border_symbols`.

#### Example

Two border symbol sets, the first one is completely custom. The latter inherits every symbol from
`Rounded` borders and overrides just the `top_left` symbol.
...
<ConfigValue name="playlist" type="string" customText="P" />
...
<ConfigValue name="song_highlighted_style" customText="<style>" />
<ConfigValue name="song_current_style" customText="<style>" />

Styles to use for the song symbol.

#### symbols.dir_style

<ConfigValue name="dir_style" customText="<style>" />
<ConfigValue name="dir_highlighted_style" customText="<style>" />
<ConfigValue name="dir_current_style" customText="<style>" />

Styles to use for the dir symbol.

#### symbols.playlist_style

<ConfigValue name="playlist_style" customText="<style>" />
<ConfigValue name="playlist_highlighted_style" customText="<style>" />
<ConfigValue name="playlist_current_style" customText="<style>" />

Styles to use for the playlist symbol.

#### symbols.marker_style

<ConfigValue name="marker_style" customText="<style>" />
<ConfigValue name="marker_highlighted_style" customText="<style>" />
<ConfigValue name="marker_current_style" customText="<style>" />

Styles to use for the marker symbol.
...
playing or song is at the very start). Defaults to `true`.
...
Do not use. Deprecated in favor of the [layout config](/configuration/layout).
...
<ConfigValue name="song_table_format" type="other" customText="<song_table_format>" href="/configuration/song-table/" />
...
<ConfigValue name="browser_song_format" type="other" customText="<property[]>" href="/configuration/properties" />

Format used to display song in the various browser panes (directories, albums, artists, ...).
Is the same format as [song_table_format](/configuration/song-table#prop) except the styles are ignored.
...
<ConfigValue name="lyrics.alignment" type={["Left", "Center", "Right"]}  />
