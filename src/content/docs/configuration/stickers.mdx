...
| `lastPlayed` | Unix timestamp (seconds) of the last time the song was played. Can be read by the [Sticker](/configuration/panes#sticker) pane (e.g. a "recently played" view). Must be written by an external tool such as an [rmpcd plugin](https://github.com/rmpc-org/rmpcd-lastplayed) or an [`on_song_change`](/guides/on_song_change) hook. |
