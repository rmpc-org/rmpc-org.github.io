...
3.  Configure the pane layout to include Cava. This goes in your `config.ron` under the tabs section. Below is
    ...
    See [Panes documentation](/configuration/panes) for more information about configuring panes.

</Steps>

## Theming

The look of visualiser can be configured in your [theme](/configuration/theme#cava)
...
cava: (
    ...
    // Instead of directly coloring the inverted bar symbols, colors the space around them
